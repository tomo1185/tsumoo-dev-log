...
- 認証、アカウント、ToDo、振り返り API の責務とエンドポイント方針を整理
- Laravel / Next.js の責務分離を整理
- Cookie セッション + CSRF を前提にした認証連携方針を整理
- メール確認前ユーザーの扱いを整理
- ToDo 一覧のページング、表示ラベル、エラー形式、成功ステータスの方針を整理
- ステータス型 ToDo の完了取消時に、完了前ステータスへ戻す方針を整理
