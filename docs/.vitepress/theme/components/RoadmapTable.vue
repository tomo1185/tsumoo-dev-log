...
const tasks = [
  ...
  ["TSUMOO-44", "フェーズ1", "開発", "開発中に追加した補助タスク", "完了", "3h", "6/16", "6/16"],
  ["TSUMOO-45", "フェーズ1", "開発", "ローカル開発環境の Next.js HMR 接続整理", "完了", "4h", "6/16", "6/16"],
  ...
  ["TSUMOO-17", "フェーズ1", "開発", "タスク一覧表示実装", "完了", "6h", "6/22", "6/25"],
  ["TSUMOO-18", "フェーズ1", "開発", "タスク作成処理実装", "完了", "6h", "6/22", "6/25"],
  ["TSUMOO-19", "フェーズ1", "開発", "タスク編集・削除処理実装", "完了", "6h", "6/22", "6/25"],
  ["TSUMOO-20", "フェーズ1", "開発", "タスク完了・完了取消処理実装", "完了", "5h", "6/23", "6/25"],
  ["TSUMOO-21", "フェーズ1", "開発", "タスク一覧フィルター実装", "完了", "6h", "6/23", "6/25"],
  ["TSUMOO-47", "フェーズ1", "開発", "ダッシュボード 達成状況実装", "完了", "6h", "6/25", "6/25"],
  ["TSUMOO-48", "フェーズ1", "開発", "タスク一覧修正", "完了", "3h", "6/26", "6/26"],
  ["TSUMOO-22", "フェーズ1", "開発", "PC向け一括登録実装", "完了", "6h", "6/26", "6/26"],
  ["TSUMOO-23", "フェーズ1", "開発", "達成状況・振り返り画面実装", "完了", "6h", "6/27", "6/29"],
  ["TSUMOO-49", "フェーズ1", "改善", "アカウント情報取得の共通化とAPI重複削減", "完了", "4h", "6/26", "6/30"],
  ["TSUMOO-50", "フェーズ1", "改善", "ダッシュボードのタスク管理画面化", "完了", "4h", "6/30", "6/30"],
  ["TSUMOO-51", "フェーズ1", "改善", "参照系APIのTanStack Query移行とキャッシュ管理整理", "完了", "6h", "7/1", "7/3"],
  ["TSUMOO-52", "フェーズ1", "改善", "アプリ画面APIの重複取得削減とログアウト制限干渉の解消", "完了", "4h", "7/1", "7/1"],
  ["TSUMOO-53", "フェーズ1", "改善", "タスク管理機能の責務整理", "完了", "12h", "7/4", "7/5"],
  ["TSUMOO-54", "フェーズ1", "リファクタリング", "タスク管理API契約・エラー形式整理", "完了", "6h", "7/5", "7/5"],
  ["TSUMOO-55", "フェーズ1", "設計整理", "カテゴリ機能に向けたタスク管理設計整理", "完了", "6h", "7/5", "7/7"],
  ["TSUMOO-56", "フェーズ1", "リファクタリング", "一括管理機能に向けたタスク操作設計整理", "完了", "3h", "7/8", "7/10"],
  ["TSUMOO-57", "フェーズ1", "リファクタリング", "一括管理API契約・エラー形式整理", "完了", "3h", "7/8", "7/10"],
  ["TSUMOO-58", "フェーズ1", "リファクタリング", "振り返り機能の責務整理", "完了", "3h", "7/9", "7/10"],
  ["TSUMOO-59", "フェーズ1", "リファクタリング", "振り返りAPI契約・エラー形式整理", "完了", "3h", "7/11", "7/17"],
  ["TSUMOO-60", "フェーズ1", "リファクタリング", "設定機能の責務整理", "未着手", "3h", "7/10", "7/10"],
  ["TSUMOO-61", "フェーズ1", "リファクタリング", "設定API契約・エラー形式整理", "未着手", "3h", "7/10", "7/10"],
  ["TSUMOO-62", "フェーズ1", "リファクタリング", "認証機能の責務整理", "未着手", "4h", "7/11", "7/11"],
  ["TSUMOO-63", "フェーズ1", "リファクタリング", "認証API契約・エラー形式整理", "未着手", "4h", "7/11", "7/11"],
  ["TSUMOO-64", "フェーズ1", "リファクタリング", "フロント横断責務整理", "未着手", "2h", "7/12", "7/12"],
  ["TSUMOO-65", "フェーズ1", "リファクタリング", "API契約・エラー形式の横断整理", "未着手", "3h", "7/12", "7/12"],
  ["TSUMOO-66", "フェーズ1", "リファクタリング", "テスト・品質方針整理", "未着手", "3h", "7/13", "7/13"],
  ["TSUMOO-67", "フェーズ1", "リファクタリング", "開発/運用ドキュメント整理", "未着手", "3h", "7/13", "7/13"],
  ["TSUMOO-24", "フェーズ1", "開発", "アカウント設定実装", "完了", "6h", "6/19", "6/19"],
  ["TSUMOO-41", "フェーズ1", "開発", "Google連携解除実装", "完了", "6h", "6/21", "6/21"],
  ["TSUMOO-46", "フェーズ1", "開発", "Google再連携実装", "完了", "6h", "6/21", "6/21"],
  ["TSUMOO-42", "フェーズ1", "開発", "退会処理実装", "完了", "4h", "6/22", "6/23"],
