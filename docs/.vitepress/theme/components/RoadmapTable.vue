...
const tasks = [
  ...
  ["TSUMOO-39", "フェーズ1", "リファクタリング", "フロントエンド共通化・リファクタリング", "完了", "8h", "6/10", "6/10"],
  ["TSUMOO-40", "フェーズ1", "リファクタリング", "タスク管理への命名整理", "完了", "4h", "6/10", "6/10"],
  ["TSUMOO-11", "フェーズ1", "開発", "登録処理実装", "後続予定", "5h", "6/11", "6/12"],
  ["TSUMOO-12", "フェーズ1", "開発", "ログイン・ログアウト処理実装", "後続予定", "5h", "6/12", "6/13"],
  ["TSUMOO-13", "フェーズ1", "開発", "Google認証処理実装", "後続予定", "6h", "6/13", "6/14"],
  ["TSUMOO-14", "フェーズ1", "開発", "パスワードリセット処理実装", "後続予定", "5h", "6/14", "6/15"],
  ["TSUMOO-15", "フェーズ1", "開発", "アプリ共通レイアウト実装", "後続予定", "5h", "6/15", "6/16"],
  ["TSUMOO-16", "フェーズ1", "開発", "タスク一覧表示処理実装", "後続予定", "6h", "6/16", "6/17"],
  ["TSUMOO-17", "フェーズ1", "開発", "タスク作成処理実装", "後続予定", "6h", "6/17", "6/18"],
  ["TSUMOO-18", "フェーズ1", "開発", "タスク編集・削除処理実装", "後続予定", "6h", "6/18", "6/19"],
  ["TSUMOO-19", "フェーズ1", "開発", "タスク完了・完了取消処理実装", "後続予定", "5h", "6/19", "6/20"],
  ["TSUMOO-20", "フェーズ1", "開発", "タスク一覧フィルター実装", "後続予定", "6h", "6/20", "6/21"],
  ["TSUMOO-21", "フェーズ1", "開発", "PC向け一括登録実装", "後続予定", "6h", "6/21", "6/22"],
  ["TSUMOO-22", "フェーズ1", "開発", "達成状況・振り返り処理実装", "後続予定", "6h", "6/22", "6/23"],
  ["TSUMOO-23", "フェーズ1", "開発", "アカウント設定処理実装", "後続予定", "6h", "6/23", "6/24"],
  ["TSUMOO-24", "フェーズ1", "テスト", "テスト方針整理", "後続予定", "3h", "6/24", "6/25"],
  ["TSUMOO-25", "フェーズ1", "テスト", "フェーズ1動作確認・修正", "後続予定", "8h", "6/25", "6/27"],
  ["TSUMOO-26", "共通", "環境整備", "VPSデプロイ手順整備", "後続予定", "4h", "6/27", "6/28"],
  ["TSUMOO-27", "共通", "ドキュメント整備", "README・開発手順整備", "後続予定", "3h", "6/28", "6/29"],
  ["TSUMOO-28", "共通", "公開ログ整備", "tsumoo-dev-log更新", "後続予定", "3h", "6/29", "6/30"],
  ["TSUMOO-29", "フェーズ1", "リリース準備", "フェーズ1リリース前調整", "後続予定", "5h", "6/30", "7/1"]
];
