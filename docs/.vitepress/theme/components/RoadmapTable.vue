...
const tasks = [
  ...
  ["TSUMOO-61", "フェーズ1", "リファクタリング", "設定API契約・エラー形式整理", "完了", "3h", "7/22", "7/23"],
  ["TSUMOO-62", "フェーズ1", "リファクタリング", "認証機能の責務整理", "完了", "4h", "7/23", "7/23"],
  ["TSUMOO-63", "フェーズ1", "リファクタリング", "認証API契約・エラー形式整理", "完了", "4h", "7/23", "7/23"],
