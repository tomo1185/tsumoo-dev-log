...
const tasks = [
  ...
  ["TSUMOO-7", "フェーズ1", "詳細設計", "API設計", "未着手", "6h", "5/27", "5/31"],
  ["TSUMOO-8", "共通", "環境整備", "アプリケーション初期構築", "未着手", "5h", "5/29", "6/2"],
  ["TSUMOO-9", "共通", "環境整備", "開発環境・基本設定整備", "未着手", "4h", "5/30", "6/2"],
  ["TSUMOO-10", "フェーズ1", "開発", "公開トップページ実装", "未着手", "4h", "5/31", "6/3"],
  ["TSUMOO-11", "フェーズ1", "開発", "認証画面実装", "未着手", "5h", "6/1", "6/5"],
  ["TSUMOO-12", "フェーズ1", "開発", "登録処理実装", "未着手", "5h", "6/2", "6/6"],
  ["TSUMOO-13", "フェーズ1", "開発", "ログイン・ログアウト処理実装", "未着手", "5h", "6/3", "6/7"],
  ["TSUMOO-14", "フェーズ1", "開発", "Google認証処理実装", "未着手", "6h", "6/5", "6/9"],
  ["TSUMOO-15", "フェーズ1", "開発", "パスワードリセット処理実装", "未着手", "5h", "6/6", "6/10"],
  ["TSUMOO-16", "フェーズ1", "開発", "アプリ共通レイアウト実装", "未着手", "5h", "6/7", "6/11"],
  ["TSUMOO-17", "フェーズ1", "開発", "ToDo一覧表示実装", "未着手", "6h", "6/9", "6/13"],
  ["TSUMOO-18", "フェーズ1", "開発", "ToDo作成処理実装", "未着手", "6h", "6/10", "6/14"],
  ["TSUMOO-19", "フェーズ1", "開発", "ToDo編集・削除処理実装", "未着手", "6h", "6/12", "6/16"],
  ["TSUMOO-20", "フェーズ1", "開発", "ToDo完了・完了取消処理実装", "未着手", "5h", "6/13", "6/17"],
  ["TSUMOO-21", "フェーズ1", "開発", "ToDo一覧フィルター実装", "未着手", "6h", "6/14", "6/18"],
  ["TSUMOO-22", "フェーズ1", "開発", "PC向け一括登録実装", "未着手", "6h", "6/16", "6/20"],
  ["TSUMOO-23", "フェーズ1", "開発", "達成状況・振り返り画面実装", "未着手", "6h", "6/17", "6/21"],
  ["TSUMOO-24", "フェーズ1", "開発", "アカウント設定画面実装", "未着手", "5h", "6/19", "6/23"],
  ["TSUMOO-25", "フェーズ1", "開発", "アカウント設定処理実装", "未着手", "6h", "6/20", "6/24"],
  ["TSUMOO-26", "フェーズ1", "テスト", "テスト方針整理", "未着手", "3h", "6/22", "6/25"],
  ["TSUMOO-27", "フェーズ1", "テスト", "フェーズ1動作確認・修正", "未着手", "8h", "6/22", "6/26"],
  ["TSUMOO-28", "共通", "環境整備", "VPSデプロイ手順整備", "未着手", "4h", "6/24", "6/27"],
  ["TSUMOO-29", "共通", "ドキュメント整備", "README・開発手順整備", "未着手", "3h", "6/25", "6/28"],
  ["TSUMOO-30", "共通", "公開ログ整備", "tsumoo-dev-log更新", "未着手", "3h", "6/26", "6/29"]
];
