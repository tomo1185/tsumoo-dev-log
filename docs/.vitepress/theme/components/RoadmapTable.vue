...
const tasks = [
  ...
  ["TSUMOO-56", "フェーズ1", "リファクタリング", "一括管理機能に向けたタスク操作設計整理", "未着手", "3h", "7/8", "7/8"],
  ["TSUMOO-57", "フェーズ1", "リファクタリング", "一括管理API契約・エラー形式整理", "未着手", "3h", "7/8", "7/8"],
  ["TSUMOO-58", "フェーズ1", "リファクタリング", "振り返り機能の責務整理", "未着手", "3h", "7/9", "7/9"],
  ["TSUMOO-59", "フェーズ1", "リファクタリング", "振り返りAPI契約・エラー形式整理", "未着手", "3h", "7/9", "7/9"],
