...
const tasks = [
  ...
  ["TSUMOO-17", "フェーズ1", "開発", "タスク一覧表示実装", "進行中", "6h", "6/22", "6/24"],
  ["TSUMOO-18", "フェーズ1", "開発", "タスク作成処理実装", "進行中", "6h", "6/22", "6/24"],
  ["TSUMOO-19", "フェーズ1", "開発", "タスク編集・削除処理実装", "進行中", "6h", "6/22", "6/24"],
  ["TSUMOO-20", "フェーズ1", "開発", "タスク完了・完了取消処理実装", "進行中", "5h", "6/23", "6/24"],
  ["TSUMOO-21", "フェーズ1", "開発", "タスク一覧フィルター実装", "進行中", "6h", "6/23", "6/24"],
