...
export default defineConfig({
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: "開発ログ", link: "/dev-logs/2026-07/2026-07-23" },
    ...
    sidebar: [
      ...
      },
      {
        text: "開発ログ",
        items: [
          { text: "2026年7月23日（木）", link: "/dev-logs/2026-07/2026-07-23" },
          { text: "2026年7月22日（水）", link: "/dev-logs/2026-07/2026-07-22" },
          { text: "2026年7月17日（金）", link: "/dev-logs/2026-07/2026-07-17" },
          { text: "2026年7月13日（月）", link: "/dev-logs/2026-07/2026-07-13" },
          { text: "2026年7月11日（土）", link: "/dev-logs/2026-07/2026-07-11" },
          { text: "2026年7月10日（金）", link: "/dev-logs/2026-07/2026-07-10" },
          { text: "2026年7月8日（水）", link: "/dev-logs/2026-07/2026-07-08" },
          { text: "2026年7月7日（火）", link: "/dev-logs/2026-07/2026-07-07" },
          { text: "2026年7月6日（月）", link: "/dev-logs/2026-07/2026-07-06" },
          { text: "2026年7月5日（日）", link: "/dev-logs/2026-07/2026-07-05" },
          { text: "2026年7月4日（土）", link: "/dev-logs/2026-07/2026-07-04" },
          { text: "2026年7月3日（金）", link: "/dev-logs/2026-07/2026-07-03" },
          { text: "2026年7月2日（木）", link: "/dev-logs/2026-07/2026-07-02" },
          { text: "2026年7月1日（水）", link: "/dev-logs/2026-07/2026-07-01" },
          { text: "2026年6月30日（火）", link: "/dev-logs/2026-06/2026-06-30" },
          { text: "2026年6月29日（月）", link: "/dev-logs/2026-06/2026-06-29" },
          { text: "2026年6月28日（日）", link: "/dev-logs/2026-06/2026-06-28" },
          { text: "2026年6月27日（土）", link: "/dev-logs/2026-06/2026-06-27" },
          { text: "2026年6月26日（金）", link: "/dev-logs/2026-06/2026-06-26" },
          { text: "2026年6月25日（木）", link: "/dev-logs/2026-06/2026-06-25" },
          { text: "2026年6月24日（水）", link: "/dev-logs/2026-06/2026-06-24" },
          { text: "2026年6月23日（火）", link: "/dev-logs/2026-06/2026-06-23" },
          { text: "2026年6月22日（月）", link: "/dev-logs/2026-06/2026-06-22" },
          { text: "2026年6月21日（日）", link: "/dev-logs/2026-06/2026-06-21" },
          { text: "2026年6月20日（土）", link: "/dev-logs/2026-06/2026-06-20" },
          { text: "2026年6月19日（金）", link: "/dev-logs/2026-06/2026-06-19" },
          { text: "2026年6月18日（木）", link: "/dev-logs/2026-06/2026-06-18" },
          { text: "2026年6月17日（水）", link: "/dev-logs/2026-06/2026-06-17" },
          { text: "2026年6月16日（火）", link: "/dev-logs/2026-06/2026-06-16" },
